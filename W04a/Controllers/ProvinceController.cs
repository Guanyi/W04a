...
namespace W04a.Controllers
{
    public class ProvinceController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include="ProvinceId,ProvinceName")] Province province)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="ProvinceId,ProvinceName")] Province province)
        {
            if (ModelState.IsValid)
            {
